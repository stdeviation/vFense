...
class AgentAppsRecurrentJobManager(AgentAppsJobManager):
    def _set_funcs(self):
    ...
    def yearly(self, job_name, start_date,
        ...
        """Install applications by severity on a yearly basis.
        Args:
    ...
    def monthly(self, install, job_name, start_date,
               end_date=None, time_zone=None, **kwargs):
        """Install applications by severity on a monthly basis.
        Args:
            install (Install): An instance of Install.
            job_name (str): The name of this job.
            start_date (float): The unix time, aka epoch time
    ...
    def weekly(self, install, job_name, start_date,
               end_date=None, time_zone=None, **kwargs):
        """Install applications by severity on a weekly basis.
        Args:
            install (Install): An instance of Install.
            job_name (str): The name of this job.
            start_date (float): The unix time, aka epoch time
    ...
    def daily(self, install, job_name, start_date,
               end_date=None, time_zone=None, **kwargs):
        """Install applications by severity on a daily basis.
        Args:
            install (Install): An instance of Install.
            job_name (str): The name of this job.
            start_date (float): The unix time, aka epoch time
...
class TagAppsRecurrentJobManager(AgentAppsRecurrentJobManager):
    def _set_funcs(self):
