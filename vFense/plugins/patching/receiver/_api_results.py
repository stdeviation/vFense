...
from vFense.plugins.patching.receiver.api.updatesapplications import (
    UpdateApplicationsV1
)
from vFense.plugins.patching.receiver.api.refresh_apps import RefreshAppsV2
